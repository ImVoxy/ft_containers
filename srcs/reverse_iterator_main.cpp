...
int reverse_iterator_test()
{
    ...
    *ft_rev_from++;
    ...
    std::reverse_iterator<iter_type> rev_it2;
    ft::reverse_iterator<iter_type> ft_rev_it2;
    std::reverse_iterator<iter_type> rev_until2 (from2);
    std::reverse_iterator<iter_type> rev_from2 (until2);
    ft::reverse_iterator<iter_type> ft_rev_until2 (from2);
    ft::reverse_iterator<iter_type> ft_rev_from2 (until2);
    rev_until2--;
    ft_rev_until2--;
    std::cout << "rev_from = " << *rev_from2 << " rev_until = " << *rev_until2 << std::endl;
    std::cout << "ft_rev_from = " << *ft_rev_from2 << " ft_rev_until = " << *ft_rev_until2 << std::endl;
    std::cout << "rev_from == rev_until -> " << (*rev_from2 == *rev_until2) << std::endl;
    std::cout << "ft_rev_from == ft_rev_until -> " << (*ft_rev_from2 == *ft_rev_until2) << std::endl;
    std::cout << "rev_from != rev_until -> " << (*rev_from2 != *rev_until2) << std::endl;
    std::cout << "ft_rev_from != ft_rev_until -> " << (*ft_rev_from2 != *ft_rev_until2) << std::endl;
    std::cout << "rev_from < rev_until -> " << (*rev_from2 < *rev_until2) << std::endl;
    std::cout << "ft_rev_from < ft_rev_until2 -> " << (*ft_rev_from2 < *ft_rev_until2) << std::endl;
    std::cout << "rev_from <= rev_until -> " << (*rev_from2 <= *rev_until2) << std::endl;
    std::cout << "ft_rev_from <= ft_rev_until -> " << (*ft_rev_from2 <= *ft_rev_until2) << std::endl;
    std::cout << "rev_from > rev_until -> " << (*rev_from2 > *rev_until2) << std::endl;
    std::cout << "ft_rev_from > ft_rev_until -> " << (*ft_rev_from2 > *ft_rev_until2) << std::endl;
